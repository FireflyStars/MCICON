                 ...
                 <tr style="border-collapse:collapse;">
                  <td width="560" valign="top" align="center" style="padding:0;Margin:0;">
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                     ...
                     <tr style="border-collapse:collapse;">
                      <td align="center" style="padding:0;Margin:0;padding-top:15px;font-size:16px;line-height:20px">
                        <p><span>Hi {{ $lastname }} </span></p>
                        <p>Thanks for your registering</p>
                        <p>please click below link to verify your email</p>
                        <p style="width: 100% !important; text-align: justify"> <a href="https://bt4.uniq-st.com/verify/{{ $token }}">Verify Your Email</a> </p>
                        <p>Thanks MCICON Team</p>
                        <p>Regards</p>
                      </td>
                     </tr>
                   </table> </td>
